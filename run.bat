...
wcl -za99 -c -0 -d0 -ms -s -wx -zl ./KDOS/kernel/utils/console-io.c ./KDOS/kernel/kernel.c -fo=./build/|| goto :exit
wlink FILE ./build/kernel-entry.obj,./build/console-io.obj,./build/kernel.obj FORMAT RAW BIN NAME ./build/kernel.bin OPTION NODEFAULTLIBS, START=_cstart_ || goto :exit
